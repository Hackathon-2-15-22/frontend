...
const ExpenseForm = (props) => {
  const [expenseList, setExpenseList] = useState([{ category: "", amount: "" }]);
        ...
        <div className="form-field">
          ...
          {expenseList.map((singleExpense, index) => (
            <div key={index} className="expenses">
                <select name="category" required onChange={(e) => handleExpenseChange(e, index)} value={singleExpense.category}>
